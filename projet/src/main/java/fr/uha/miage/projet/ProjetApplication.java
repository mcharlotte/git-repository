...
public class ProjetApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Tournoi t1 = new Tournoi(); t1.setLieu("Mulhouse"); t1.setNbJoueurMax(10); t1.setPrix(4.5); t1.setNom("Bijour"); t1.setType("Modern"); t1.setAnnee(2015); t1.setMois(11); t1.setJour(23); t1.setHeure(17); t1.setMinute(30);
		tournoiRepository.save(t1);

		//Tournoi de Pétanque à Colmar le 28/11/2015 à 13h30, 20 joueurs max, 2€
		Tournoi t2 = new Tournoi(); t2.setLieu("Colmar"); t2.setNbJoueurMax(20); t2.setPrix(2.0); t2.setNom("Bijour"); t2.setType("EDH"); t2.setAnnee(2015); t2.setMois(11); t2.setJour(28); t2.setHeure(13); t2.setMinute(30);
		tournoiRepository.save(t2);
		
		//Tournoi de Badminton à Strasbourg le 26/11/2015 à 20h, 12 joueurs max, 5€
		Tournoi t3 = new Tournoi(); t3.setLieu("Strasbourg"); t3.setNbJoueurMax(12); t3.setPrix(5.0); t3.setNom("Bijour"); t3.setType("Draft"); t3.setAnnee(2015); t3.setMois(11); t3.setJour(26); t3.setHeure(20); t3.setMinute(0);
