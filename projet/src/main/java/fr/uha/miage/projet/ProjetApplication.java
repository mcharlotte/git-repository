...
public class ProjetApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		// Jan - Cartes
		Reservation r1 = new Reservation(); r1.setTournoi(t1); r1.setUtilisateur(u1); r1=reservationRepository.save(r1);
		
		// Gael - Cartes
		Reservation r2 = new Reservation(); r2.setTournoi(t1); r2.setUtilisateur(u2); r2=reservationRepository.save(r2);
		
		// Ralph - Cartes
		Reservation r3 = new Reservation(); r3.setTournoi(t1); r3.setUtilisateur(u6); r3=reservationRepository.save(r3);
		
		// Jan - Pétanque
		Reservation r4 = new Reservation(); r4.setTournoi(t2); r4.setUtilisateur(u1); r4=reservationRepository.save(r4);
		
		// Gael - Pétanque
		Reservation r5 = new Reservation(); r5.setTournoi(t2); r5.setUtilisateur(u2); r5=reservationRepository.save(r5);
		
		// Ralph - Pétanque
		Reservation r6 = new Reservation(); r6.setTournoi(t2); r6.setUtilisateur(u6); r6=reservationRepository.save(r6);
		
		// Audrey - Pétanque
		Reservation r7 = new Reservation(); r7.setTournoi(t2); r7.setUtilisateur(u4); r7=reservationRepository.save(r7);
		
		// Sophie - Pétanque
		Reservation r8 = new Reservation(); r8.setTournoi(t2); r8.setUtilisateur(u5); r8=reservationRepository.save(r8);
		
		// Charlotte - Pétanque
		Reservation r9 = new Reservation(); r9.setTournoi(t2); r9.setUtilisateur(u3); r9=reservationRepository.save(r9);
		
		// Audrey - Badminton
		Reservation r10 = new Reservation(); r10.setTournoi(t3); r10.setUtilisateur(u4); r10=reservationRepository.save(r10);
		
		// Sophie - Badminton
		Reservation r11 = new Reservation(); r11.setTournoi(t3); r11.setUtilisateur(u5); r11=reservationRepository.save(r11);
		
		// Charlotte - Badminton
		Reservation r12 = new Reservation(); r12.setTournoi(t3); r12.setUtilisateur(u3); r12=reservationRepository.save(r12);
