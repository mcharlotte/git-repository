...
<html lang="en">
  ...
  <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#recap">Tournois récents</a>
                    </li>
                    <li>
        ...
        <div >						<!-- class="container"-->
            <div class="row">
                ...
                <select name="decision">
						<option selected>Troll à deux têtes
						<option>Draft
						<option>des
						<option>trucs en
						<option>dur
    ...
    <section id="recap">
       ...
       <!--  je sais pas encore comment mettre une bonne liste de résumé vu que plusieurs infos, 
       j'avais pu en stage mais j'avais créé moi-même un type de composant, efficace mais long -->
    </section>
